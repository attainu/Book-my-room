					...
					<div className="row">
						<div className="col-lg-4 col-md-6">
							<div className="input-wrap">
								<input type="text" value={search} onChange={textChange} name="location" placeholder="Location" id="location" />
						...
						<div className="col-lg-4 col-md-6">
							<div className="input-wrap">
								<button onClick={()=>{GetHotelList(search)}} className="btn filled-btn btn-block  btn-primary">
